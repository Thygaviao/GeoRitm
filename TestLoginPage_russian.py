...
def test_main_page():
    ...
    if vosst_parol == vosst_parol_example:
        ...
        print(f'Надпись на кнопке "{vosst_parol_example}" сломалась и вместо неё выводится {vosst_parol}')
    ...
    if registration == registration_example:
        ...
        print(f'Надпись на кнопке "{registration_example}" сломалась и вместо неё выводится {registration}')
