...
def test_localization_map():
    ...
    ritm_nadpis_example = "Il sistema è stato progettato e prodotto dall'azienda Ritm"
    print_map_example = 'Stampa la mappa'
    selfscaling_example = 'Ingrandimento automatico'
    minus_example = 'Riduci'
    plus_example = 'Ingrandisci'
    down_example = 'Giù'
    left_example = 'A sinistra'
    right_example = 'A destra'
    up_example = 'Su'
    traffic_example = 'Traffico'
    ruler_example = 'Righello'
    clean_map_example = 'Pulisci la mappa'
