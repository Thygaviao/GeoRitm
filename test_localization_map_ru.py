...
def test_localization_map():
    ...
    mashtab_example = '1 км'
    ritm_nadpis_example = 'Система разработана и производится компанией Ритм'
    print_map_example = 'Печать карты'
    selfscaling_example = 'Автомасштабирование'
    minus_example = 'Отдалить'
    plus_example = 'Приблизить'
    down_example = 'Вниз'
    left_example = 'Влево'
    right_example = 'Вправо'
    up_example = 'Вверх'
    traffic_example = 'Пробки'
    ruler_example = 'Линейка'
    clean_map_example = 'Очистить карту'
